...
class PreferencesWindowController: NSWindowController {
    ...
    lazy var tabViewController: ResizingTabViewController = {
        ...
        boorusItem.image = NSImage(systemSymbolName: "photo.on.rectangle.angled", accessibilityDescription: "Boorus")
    ...
    override func loadWindow() {
        self.window = NSWindow(contentRect: .zero, styleMask: [.titled, .closable], backing: .buffered, defer: false)
